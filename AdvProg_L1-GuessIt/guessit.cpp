...
int getPlayerGuess() {
    ...
    int number;
    cout<<endl<<"Enter your number ( min 1, max 100): ";
    cin>>number;
    return number;
}
...
string getAnswer(int number, int randomNumber) {
    ...
    ***/
    string answer="Congratulation! You win.";
    string answer1="Your number is higher.";
    string answer2="Your number is lower.";
    if(number>randomNumber) return answer1;
    if(number<randomNumber) return answer2;
    return answer;
}
...
bool checkSuccess(string answer) {
    ...
    if(answer=="Your number is lower.") return false;
    return true;
}
...
char getPlayerOpinion() {
    ...
    char isContinued;
    cout<<"Continue playing?( if YES type 'y', else type 'n')";
    cin>>isContinued;
    return isContinued;
}
